...
//require_once '../Controllers/LecturecController.php';
...
<head>
    <meta charset="utf-8">
    <title>Tracking Performance</title>
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h6 class="text-primary">Learning Management System</h6>
                </a>
        ...
        <div class="content">
            ...
            <div id="myChart" style="width:100%; max-width:1000px; height:600px;"></div>
...
// Set Data
              const data = google.visualization.arrayToDataTable([
                ...
                [1,7],[2,8],[3,8],[4,9],[5,9],
                [6,9],[7,10],[8,11],
                [9,14],[10,12],[11,13],[12,15]
              ]);
// Set Options
              const options = {
                title: 'Tracking Performance',
                hAxis: {title: 'Week Number'},
                vAxis: {title: 'Your Score'},
                legend: 'none'
              };
// Draw
